...
const Position  = styled.div`
   ...
   margin-bottom: 10px;
`
const MgtStaffProfile = () => {
  return (
    <Container>
        <Wrapper>
            <Left>
               <ProfileHeader>
                   <Hr style={{width:'90px'}}/> <h1>hadiza .s. sa’eed, esq.</h1> <Hr style={{width:'90px'}} />
               </ProfileHeader>
               <Position>
                    <span> Director.
                        (performace evaluation & legal department.) </span>
               </Position>
                    <ImageHolder>
                       <ProfileImage src='./img/hadiza.png' /> 
                    </ImageHolder>

                    <Paragraph> 
                           Hon hadiza .s. sa’eed, esq. was born on 13th June, 1957, to the family of M.B. Douglas-Mensem; a retired Appeal Court Justice.
...
export default MgtStaffProfile
